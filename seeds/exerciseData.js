var exerciseData = [
{
    ...
    "description": "Curl the dumbbells upward, keeping your elbows close to your sides. Slowly lower the weights back down to the starting position. Repeat for the desired number of repetitions.",
